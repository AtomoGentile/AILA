 ...
 *   coda come il tasto Stop della notifica Android. Se iOS non lo concede (strategia `.fail`), o
 *   su iOS 17-25 dove non esiste, resta il primo livello.
 *
...
final class BackgroundWorkBridgeImpl: BackgroundWorkBridge {
    ...
    /// Un `BGContinuedProcessingTask` (iOS 26): tenuto come AnyObject perche' l'app gira da iOS
    /// 17 e una proprieta' salvata non puo' avere un tipo disponibile solo su versioni successive.
